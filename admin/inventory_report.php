...
updated_at, detail_order_id FROM product";
...
<header id="banner">
    ...
    <script>
        ...
        function exportToCSV() {
            ...
            const headers = ["Product ID", "Listproduct ID", "Store ID", "Expiration Date", "Status", "Quantity", 
            "Location", "Manufacture date","Updated At", "Detail order ID"];
