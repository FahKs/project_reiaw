...
$orderQuery = "SELECT transaction_id, product_id, user_id, transaction_type, transaction_date, transaction_info FROM transactions";
...
<header id="banner">
                ...
                <tbody>
                    <?php foreach ($orders as $order): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($order['transaction_type']) ?></td>
                            <td><?= htmlspecialchars($order['transaction_date']) ?></td>
    ...
    <script>
        ...
        function exportToCSV() {
            ...
            const headers = ["transaction_id","product_id","user_id","transaction_type","transaction_date","transaction_info"];
